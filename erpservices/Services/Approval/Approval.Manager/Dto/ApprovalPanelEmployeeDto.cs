...
{
    [AutoMap(typeof(ApprovalPanelEmployee)), Serializable]
    public class ApprovalPanelEmployeeDto : Auditable
    {
        ...
        public List<MultipleProxyDetailsDto> MultipleProxyDetails { get; set; }
        ...
        public int? AttachmentRequiredAmount { get; set; }
    }

    [AutoMap(typeof(ApprovalPanelProxyEmployee)), Serializable]
    public class MultipleProxyDetailsDto : Auditable
    {
