...
{
    [AutoMap(typeof(PettyCashPaymentMaster)), Serializable]
    public class PettyCashPaymentMasterDto : Auditable
    {
        ...
        public List<PettyCashPaymentChildDto> ItemDetails { get; set; }
    }
}
