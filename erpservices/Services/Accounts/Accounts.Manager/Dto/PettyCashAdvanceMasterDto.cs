...
{
    [AutoMap(typeof(PettyCashAdvanceMaster)), Serializable]
    public class PettyCashAdvanceMasterDto : Auditable
    {
        ...
        public List<PettyCashAdvanceChildDto> ItemDetails { get; set; }
    }
}
